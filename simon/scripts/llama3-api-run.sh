...
lmdeploy serve api_server ${model_path} --server-port 3334 --model-name ${model_name} --tp ${tp} --chat-template llama3.json --cache-max-entry-count ${pct} --session-len ${context_len}
#--quant-policy 8
